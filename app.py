...
with st.form("checkin_form", clear_on_submit=True):
    ...
    if residence == "Ναι / Yes":
        identity_val = st.text_input("ΑΦΜ (Υποχρεωτικό)", key="gr_tax")
        country = "Ελλάδα"
    else:
        identity_val = st.text_input("Αριθμός Διαβατηρίου ή Ταυτότητας / Passport or ID Number", key="int_id")
        country = st.text_input("Χώρα Προέλευσης / Country of Origin", key="int_country")
